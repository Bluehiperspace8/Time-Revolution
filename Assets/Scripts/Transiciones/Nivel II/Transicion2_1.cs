...
/*
 Objetivo: Pasar a la transicion del laboratorio del Nivel II a su Pasillo
 Autor: Roberto Valdez Jasso
 */


public class Transicion2_1 : MonoBehaviour
{
    // Variables ---//
    ...
    private IEnumerator CambiarEscena()
    {
        ...
        SceneManager.LoadScene("Scenes/Nivel_II/Pasillo");
    }
