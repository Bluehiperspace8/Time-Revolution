...
/*
 * Objetivo: Dialogo de Jacob al encontrar el 7/14 objectos en el museo
...
public class Objecto7Museo : MonoBehaviour
{
    // Variables ---//
    ...
    public void siguienteParrafo()
    {
        ...
        {
            textD.text = "Has encontrado el objecto 7 de 14";
