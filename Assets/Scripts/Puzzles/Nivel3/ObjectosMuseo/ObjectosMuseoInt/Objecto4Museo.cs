...
/*
 * Objetivo: Dialogo de Jacob al encontrar el 4/14 objectos en el museo
...
public class Objecto4Museo : MonoBehaviour
{
    // Variables ---//
    ...
    public void siguienteParrafo()
    {
        ...
        {
            textD.text = "Has encontrado el objecto 4 de 14";
