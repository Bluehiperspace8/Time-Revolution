...
/*
 * Objetivo: Dialogo de Jacob al encontrar el 9/14 objectos en el museo
...
public class Objecto9Museo : MonoBehaviour
{
    // Variables ---//
    ...
    public void siguienteParrafo()
    {
        ...
        {
            textD.text = "Has encontrado el objecto 9 de 14";
