...
/*
 Objetivo: Dialogo de Jacob al encontrar el 13/14 objectos en el museo
 Autor: Roberto Valdez Jasso
 */

public class Objecto13Museo : MonoBehaviour
{    // Variables ---//
    ...
    public void siguienteParrafo()
    {
        ...
        {
            textD.text = "Has encontrado el objecto 13 de 14";
