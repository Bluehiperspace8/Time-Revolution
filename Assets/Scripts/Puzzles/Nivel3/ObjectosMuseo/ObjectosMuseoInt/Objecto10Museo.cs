...
/*
 Objetivo: Dialogo de Jacob al encontrar el 10/14 objectos en el museo
 Autor: Roberto Valdez Jasso
 */

public class Objecto10Museo : MonoBehaviour
{
    // Variables ---//
    ...
    public void siguienteParrafo()
    {
        ...
        {
            textD.text = "Has encontrado el objecto 10 de 14";
