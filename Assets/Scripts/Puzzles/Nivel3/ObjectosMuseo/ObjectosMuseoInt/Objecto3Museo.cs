...
/*
 Objetivo: Dialogo de Jacob al encontrar el 3/14 objectos en el museo
 Autor: Roberto Valdez Jasso
 */

public class Objecto3Museo : MonoBehaviour
{
    // Variables ---//
    ...
    public void siguienteParrafo()
    {
        ...
        {
            textD.text = "Has encontrado el objecto 3 de 14";
