...
/*
 Objetivo: Dialogo de Jacob al encontrar el 12/14 objectos en el museo
 Autor: Roberto Valdez Jasso
 */

public class Objecto12Museo : MonoBehaviour
{
    // Variables ---//
    ...
    public void siguienteParrafo()
    {
        ...
        {
            textD.text = "Has encontrado el objecto 12 de 14";
