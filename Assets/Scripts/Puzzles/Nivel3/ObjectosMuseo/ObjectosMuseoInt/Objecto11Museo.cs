...
/*
 * Objetivo: Dialogo de Jacob al encontrar el 11/14 objectos en el museo
...
public class Objecto11Museo : MonoBehaviour
{
    // Variables ---//
    ...
    public void siguienteParrafo()
    {
        ...
        {
            textD.text = "Has encontrado el objecto 11 de 14";
